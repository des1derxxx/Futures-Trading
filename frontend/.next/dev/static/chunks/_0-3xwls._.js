    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBinancePrice.useEffect": ()=>{
            ...
            function connect() {
                ...
                wsRef.current = ws;
                ws.onopen = ({
                    "useBinancePrice.useEffect.connect": ()=>setConnected(true)
                })["useBinancePrice.useEffect.connect"];
                ws.onmessage = ({
                    "useBinancePrice.useEffect.connect": (event)=>{
                ...
                ws.onerror = ({
                    "useBinancePrice.useEffect.connect": ()=>ws.close()
                })["useBinancePrice.useEffect.connect"];
            }
            connect();
            return ({
...
_s(useBinancePrice, "XTUPcjL3M+2yIReIQCj8uBH95LE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0-3xwls._.js.map